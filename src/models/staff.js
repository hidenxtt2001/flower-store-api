...
/**
 * Request to get new token auth from token refresh
 * @param {String} refreshToken
 * @returns {String} token - Token is generated by token refresh if it not expire
 */
staffSchema.statics.getNewTokenFromTokenRefresh = async function (
  refreshToken
) {
  try {
    ...
    let newToken = await staff.getNewAccessToken();
    return newToken;
  } catch (e) {
